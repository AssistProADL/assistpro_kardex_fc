...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('mv_existencia_gral_produccion_caja')) {
            Schema::create('mv_existencia_gral_produccion_caja', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `mv_existencia_gral_produccion_caja` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('mv_existencia_gral_produccion_caja');
    }
};