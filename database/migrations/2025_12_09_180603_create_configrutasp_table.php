...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('configrutasp')) {
            Schema::create('configrutasp', function (Blueprint $table) {
                $table->integer('Id');
            ...
            DB::statement("ALTER TABLE `configrutasp` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('configrutasp');
    }
};