...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('stg_colaprocesamiento')) {
            Schema::create('stg_colaprocesamiento', function (Blueprint $table) {
                $table->integer('id');
            ...
            DB::statement("ALTER TABLE `stg_colaprocesamiento` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('stg_colaprocesamiento');
    }
};