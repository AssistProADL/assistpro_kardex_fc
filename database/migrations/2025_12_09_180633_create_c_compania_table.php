...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('c_compania')) {
            Schema::create('c_compania', function (Blueprint $table) {
                $table->integer('cve_cia');
                $table->string('clave_empresa')->nullable();
            ...
            DB::statement("ALTER TABLE `c_compania` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('c_compania');
    }
};