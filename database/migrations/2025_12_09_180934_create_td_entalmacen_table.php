...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('td_entalmacen')) {
            Schema::create('td_entalmacen', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `td_entalmacen` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('td_entalmacen');
    }
};