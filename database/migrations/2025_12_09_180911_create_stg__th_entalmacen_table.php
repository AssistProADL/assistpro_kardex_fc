...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('stg__th_entalmacen')) {
            Schema::create('stg__th_entalmacen', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `stg__th_entalmacen` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('stg__th_entalmacen');
    }
};