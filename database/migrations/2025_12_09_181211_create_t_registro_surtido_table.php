...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('t_registro_surtido')) {
            Schema::create('t_registro_surtido', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `t_registro_surtido` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('t_registro_surtido');
    }
};