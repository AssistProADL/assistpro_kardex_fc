...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('stg_continuidad')) {
            Schema::create('stg_continuidad', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `stg_continuidad` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('stg_continuidad');
    }
};