...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('tmp_inventcicconteo')) {
            Schema::create('tmp_inventcicconteo', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `tmp_inventcicconteo` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('tmp_inventcicconteo');
    }
};