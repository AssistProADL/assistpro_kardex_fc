...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('detallecob')) {
            Schema::create('detallecob', function (Blueprint $table) {
                $table->integer('Id');
            ...
            DB::statement("ALTER TABLE `detallecob` ENGINE = InnoDB, CHARSET = utf8mb4, COLLATE = utf8mb4_unicode_ci");
        }
    }
    ...
    {
        Schema::dropIfExists('detallecob');
    }
};