...
.kpi-art{background:var(--ap-purple);}
.kpi-alm{background:var(--ap-blue);}
.kpi-usr{background:var(--ap-green);}
.kpi-cli{background:var(--ap-teal);}
