...
// Catálogo de almacenes SOLO desde inventarios físicos
$almacenes = db_all("
    SELECT DISTINCT almacen
    FROM v_inv_fisico_resumen
    ORDER BY almacen
");
...
// OJO: v_inv_ciclico_resumen (como lo definimos) NO tiene columna almacén,
// así que no filtramos por almacén aquí.
if ($folio !== '' && $tipo === 'C') {
    $whereCic[] = "folio_plan = ?";
    $paramsCic[] = $folio;
}
