...
// ===== Backend guard for ETL (no UI changes) =====
if (!isset($pdo) || !($pdo instanceof PDO)) {
  try {
    ...
    // Falla dura pero evita HTML roto
    die('Error de conexión a assistpro_etl_fc: ' . $e->getMessage());
  }
}

// Auto-create lightweight view if missing (read-only over staging)
try {
  ...
  // no interrumpir UI; la vista puede existir con otro nombre; el resto del script seguirá
}
// ===== End backend guard =====
