...
if ($op) {
  ...
  if ($op === 'bl_by_zona') {
    ...
    try {
      ...
      if ($alm === '' || $zona === '')
        throw new Exception('Almacén y zona requeridos');
  ...
  if ($op === 'seleccionar_prod') {
    ...
    try {
      ...
      if ($cve === '')
        throw new Exception('Clave de producto requerida');
      ...
      $row = db_row($sql, [$cve]);
      if (!$row)
        throw new Exception('Producto compuesto no encontrado o no marcado como compuesto.');
      ...
      <div class="card-body">
        ...
        <div class="row g-2 mb-3">
          ...
          <div class="col-md-3">
            ...
            <input type="text" id="txtPedido" class="form-control form-control-sm" placeholder="Pedido (opcional)">
          </div>
          <div class="col-md-3">
        ...
        <div class="row g-2 mb-3">
          ...
          <div class="col-md-2">
            ...
            <input type="number" step="0.0001" min="0" id="txtCantidadProducir" class="form-control form-control-sm"
              value="0">
          </div>
