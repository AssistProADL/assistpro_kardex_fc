            ...
            <div class="modal-body" style="font-size:10px;">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <label>IP</label>
                        <div class="d-flex">
                            <input type="number" id="ip1" class="form-control form-control-sm text-center mr-1" min="0"
                                max="255" style="width:55px;">
                            <span class="align-self-center">.</span>
                            <input type="number" id="ip2" class="form-control form-control-sm text-center mx-1" min="0"
                                max="255" style="width:55px;">
                            <span class="align-self-center">.</span>
                            <input type="number" id="ip3" class="form-control form-control-sm text-center mx-1" min="0"
                                max="255" style="width:55px;">
                            <span class="align-self-center">.</span>
                            <input type="number" id="ip4" class="form-control form-control-sm text-center ml-1" min="0"
                                max="255" style="width:55px;">
                        </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label>DPI</label>
                        <input type="number" name="Densidad_Imp" id="Densidad_Imp" class="form-control form-control-sm"
                            value="203">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label>Puerto</label>
                        <input type="number" name="PUERTO" id="PUERTO" class="form-control form-control-sm"
                            placeholder="9100">
                    </div>
                    <div class="form-group col-md-3">
