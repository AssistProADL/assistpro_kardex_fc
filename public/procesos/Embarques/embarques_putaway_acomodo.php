...
<div class="container-fluid" style="font-size:10px;">
    ...
    <form method="get" class="row g-2 mb-3" id="frmFiltrosPrincipal"
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control form-control-sm" value="<?= htmlspecialchars($cve_usuario) ?>"
                readonly>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="d-flex flex-row flex-wrap mt-1">
                <div class="form-check me-3">
                    <input class="form-check-input modo-mov" type="radio" name="modo_radio" id="rdoAcomodo"
                        value="ACOMODO" <?= $modo === 'ACOMODO' ? 'checked' : '' ?>>
                    <label class="form-check-label" for="rdoAcomodo">Acomodo</label>
                </div>
                <div class="form-check me-3">
                    <input class="form-check-input modo-mov" type="radio" name="modo_radio" id="rdoTraslado"
                        value="TRASLADO" <?= $modo === 'TRASLADO' ? 'checked' : '' ?>>
                    <label class="form-check-label" for="rdoTraslado">Traslado</label>
                </div>
                <div class="form-check me-3">
                    <input class="form-check-input modo-mov" type="radio" name="modo_radio" id="rdoXD" value="XD"
                        <?= $modo === 'XD' ? 'checked' : '' ?>>
    ...
    <?php if ($folio_sel !== '' && ($modo === 'ACOMODO' || $modo === 'XD')): ?>
        <div class="row">
            <div class="col-12">
                ...
                <div class="table-responsive">
                    <table id="tblPendientesAcomodo" class="table table-striped table-bordered table-sm"
                        style="width:100%;">
                        <thead>
                            <tr>
                                <th>Seleccionar</th>
