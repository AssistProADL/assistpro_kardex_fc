...
<head>
    ...
    <style>
        ...
        textarea { font-size: 11px; height: 160px; }
    </style>
</head>
<body>
                    ...
                    <select name="smtp_config_id" class="form-select form-select-sm">
                        <?php foreach ($smtps as $s): ?>
                            <option value="<?= (int)$s['id'] ?>"
                                <?= isset($_POST['smtp_config_id']) && (int)$_POST['smtp_config_id'] === (int)$s['id'] ? 'selected' : '' ?>>
                    ...
                    <select name="plantilla_id" class="form-select form-select-sm">
                        ...
                        <?php foreach ($plantillas as $p): ?>
                            <option value="<?= (int)$p['id'] ?>"
                                <?= isset($_POST['plantilla_id']) && (int)$_POST['plantilla_id'] === (int)$p['id'] ? 'selected' : '' ?>>
