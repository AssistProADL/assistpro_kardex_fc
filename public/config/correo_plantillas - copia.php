                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <small class="text-muted">
                            ...
                            Puedes usar marcadores como <code>{NOMBRE}</code>, <code>{SALDO}</code>,
                            <code>{FECHA}</code>.
                            ...
                            <tbody>
                                <?php foreach ($rows as $r): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="correo_plantillas.php?id=<?= (int) $r['id'] ?>"
                                ...
                                <?php if (!$rows): ?>
                                    <tr>
                                        <td colspan="6" class="text-center">No hay plantillas registradas.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
