    ...
    <div class="ap-card">
        ...
        <div class="ap-card-body">
            <form id="form-importador" enctype="multipart/form-data">
                <div class="row mb-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="tipo_ingreso" id="tipo_ingreso" class="form-control ap-form-control">
                            <option value="">[Seleccione]</option>
                            <option value="OCN">OCN - Orden de Compra Nacional</option>
                            <option value="OCN_PUT">OCN + Acomodo (BL destino)</option>
                            <option value="OCI">OCI - Orden de Compra Internacional</option>
                            <option value="OCI_PUT">OCI + Acomodo (BL destino)</option>
                ...
                <input type="hidden" name="acomodo_auto" id="acomodo_auto" value="0">
            </form>
        </div>
    </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content" style="border-radius:10px; overflow:hidden;">
      <div class="modal-header" style="background:#0F5AAD;color:#fff;">
        <h6 class="modal-title"><i class="fa fa-upload"></i> Importar ingresos</h6>
      ...
      <div class="modal-body" style="font-size:11px;">
        <div class="row">
            <div class="col-md-4">
                ...
                <select id="modal_tipo_ingreso" class="form-control ap-form-control">
                    <option value="">[Seleccione]</option>
                    <option value="OCN">OCN - Orden de Compra Nacional</option>
                    <option value="OCN_PUT">OCN + Acomodo (BL destino)</option>
                    <option value="OCI">OCI - Orden de Compra Internacional</option>
            ...
            <div class="col-md-4">
                ...
                <input type="file" id="modal_archivo" class="form-control ap-form-control">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="1" id="modal_chk_acomodo_auto">
                    <label class="form-check-label" for="modal_chk_acomodo_auto" style="font-size:11px;">
...
const API_IMPORT  = '../api/importador_ingresos.php';
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  document.getElementById('btn-abrir-modal').addEventListener('click', function(){
    ...
    const tipoMain=document.getElementById('tipo_ingreso').value||'';
    document.getElementById('modal_tipo_ingreso').value=tipoMain;
    document.getElementById('modal_layout_hint').innerText=tipoMain?('Layout listo para: '+tipoMain):'';
  ...
  document.getElementById('modal_tipo_ingreso').addEventListener('change', function(){
    const tipo=this.value||'';
    document.getElementById('tipo_ingreso').value=tipo;
    document.getElementById('modal_layout_hint').innerText=tipo?('Layout listo para: '+tipo):'';
  });

  // ✅ Layout ahora sí depende del tipo seleccionado
  document.getElementById('modal_btn_layout').addEventListener('click', function(){
    const tipo=document.getElementById('modal_tipo_ingreso').value;
    if(!tipo){ alert('Seleccione el tipo de importador.'); return; }
    window.location.href = API_IMPORT + '?action=layout&tipo_ingreso=' + encodeURIComponent(tipo);
  });
  ...
  document.getElementById('modal_btn_previsualizar').addEventListener('click', function(){
    ...
    const acomodo=document.getElementById('modal_chk_acomodo_auto').checked?'1':'0';
    document.getElementById('acomodo_auto').value=acomodo;
    fd.set('acomodo_auto',acomodo);
