...
function ejemplo_por_tipo(string $tipo, array $cols): array {
    ...
    if (isset($map['empresa_id']))     $row[$map['empresa_id']]     = '1';
    if (isset($map['almacen_clave']))  $row[$map['almacen_clave']]  = 'ALM01';
    if (isset($map['tipo_ingreso']))   $row[$map['tipo_ingreso']]   = $tipo;
    if (isset($map['producto']))       $row[$map['producto']]       = 'PROD001';
    if (isset($map['cantidad']))       $row[$map['cantidad']]       = '100';
    if (isset($map['uom']))            $row[$map['uom']]            = 'PZ';
    if (isset($map['bl_destino']))     $row[$map['bl_destino']]     = 'BL-001-01-01';
    if (isset($map['nivel']))          $row[$map['nivel']]          = 'PZ';
    if (isset($map['id_contenedor']))  $row[$map['id_contenedor']]  = 'CT0001';
    if (isset($map['id_pallet']))      $row[$map['id_pallet']]      = 'LP0001';
    if (isset($map['epc']))            $row[$map['epc']]            = 'E2801160600002A3B4C5D6E7';
    if (isset($map['code']))           $row[$map['code']]           = '7500000000001';
    if (isset($map['lote']))           $row[$map['lote']]           = 'L202511';
    if (isset($map['caducidad']))      $row[$map['caducidad']]      = '2026-12-31';
...
function action_previsualizar(): void {
    ...
    while (($data = fgetcsv($handle)) !== false) {
        ...
        if ($estado === 'OK')     $total_ok++;
        if ($estado === 'ERROR')  $total_err++;
