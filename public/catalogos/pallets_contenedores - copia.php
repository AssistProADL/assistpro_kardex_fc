    ...
    <div class="ap-form" style="margin-top:10px">
      <div class="ap-field">
        ...
        <div class="ap-input"><i class="fa fa-warehouse"></i>
          <input id="cve_almac" oninput="this.value=this.value.replace(/[^0-9]/g,'')" placeholder="ID almacén (c_almacenp.id)">
        </div>
      ...
      <div class="ap-field">
        ...
        <div class="ap-input"><i class="fa fa-cogs"></i><input id="TipoGen" oninput="this.value=this.value.replace(/[^0-9]/g,'')" placeholder="1"></div>
      </div>

      <div class="ap-field"><div class="ap-label">Alto</div><div class="ap-input"><i class="fa fa-ruler-vertical"></i><input id="alto" oninput="this.value=this.value.replace(/[^0-9]/g,'')" placeholder="120"></div></div>
      <div class="ap-field"><div class="ap-label">Ancho</div><div class="ap-input"><i class="fa fa-ruler-horizontal"></i><input id="ancho" oninput="this.value=this.value.replace(/[^0-9]/g,'')" placeholder="1200"></div></div>
      <div class="ap-field"><div class="ap-label">Fondo</div><div class="ap-input"><i class="fa fa-ruler"></i><input id="fondo" oninput="this.value=this.value.replace(/[^0-9]/g,'')" placeholder="800"></div></div>

      <div class="ap-field"><div class="ap-label">Peso</div><div class="ap-input"><i class="fa fa-weight"></i><input id="peso" placeholder="2.000"></div></div>
      <div class="ap-field"><div class="ap-label">Peso Máximo</div><div class="ap-input"><i class="fa fa-weight-hanging"></i><input id="pesomax" placeholder="1200.000"></div></div>
      <div class="ap-field"><div class="ap-label">Capacidad Vol</div><div class="ap-input"><i class="fa fa-cube"></i><input id="capavol" placeholder="1.700"></div></div>

      <div class="ap-field"><div class="ap-label">Costo</div><div class="ap-input"><i class="fa fa-dollar-sign"></i><input id="Costo" placeholder="0.000"></div></div>
...
<div class="ap-modal" id="mdlImport">
  <div class="ap-modal-content">
    <h3>Importar pallets / contenedores</h3>
...
let filtroAlmClave = ''; // <-- CLAVE (WH1/WH2/WH3)
