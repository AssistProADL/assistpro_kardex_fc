...
<div class="ap-container">
  <div class="ap-title"><i class="fa fa-ban"></i> Catálogo · Motivos No Venta</div>

  <div class="ap-cards">
    <div class="ap-card" id="card1">
      <div class="h">
...
<div class="ap-modal" id="mdl">
  <div class="ap-modal-content">
    <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap">
      <h3 style="margin:0"><i class="fa fa-ban"></i> Motivo No Venta</h3>
      <div class="ap-chip"><span style="color:#dc3545;font-weight:700">*</span> Obligatorios: <b>Clave</b>, <b>Motivo</b></div>
    </div>
    ...
    <div class="ap-form" style="margin-top:10px">
      ...
      <div class="ap-field">
        ...
        <div class="ap-input"><i class="fa fa-align-left"></i><input id="Motivo" placeholder="Cliente no estaba / Sin stock / No recibió..."></div>
