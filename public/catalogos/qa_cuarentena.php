...
<div class="ap-modal" id="mdl">
  <div class="ap-modal-content">
    <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap">
      ...
      <div class="ap-chip"><span style="color:#dc3545;font-weight:700">*</span> Obligatorios: <b>Tipo</b> y <b>Motivo</b></div>
    </div>
    ...
    <div class="ap-form" style="margin-top:10px">
      ...
      <div class="ap-field">
        ...
        <div class="ap-input"><i class="fa fa-align-left"></i><input id="Des_Motivo" placeholder="Ej. Producto dañado / Falla de calidad / Contaminación..."></div>
...
<div class="ap-modal" id="mdlImport">
  <div class="ap-modal-content">
    ...
    <div class="ap-chip">Layout con UPSERT por <b>(Tipo_Cat + Des_Motivo)</b>. Entrada puede venir como <b>E</b> o <b>Q</b>.</div>
  ...
  fetch(KPI+'?action=kpi').then(r=>r.json()).then(rows=>{
    ...
    rows.forEach(x=>{
      ...
      <div class="ap-card" onclick="setTipo('${String(t).replace(/'/g,"\\'")}')">
        <div class="h">
          <b><i class="fa fa-shield-alt"></i> ${label}</b>
...
function setTipo(t){
  filtroTipo = t || '';
  tipoLabel.innerHTML = `<i class="fa fa-filter"></i> Tipo: <b>${filtroTipo?tipoTxt(filtroTipo):'Todos'}</b> ${
    filtroTipo?'<span class="ap-chip" style="cursor:pointer" onclick="setTipo(\'\')">Quitar</span>':''
  }`;
  page = 1;
  cargar();
}
...
function guardar(){
  ...
  fd.append('Tipo_Cat', Tipo_Cat.value); // API convertirá E->Q
