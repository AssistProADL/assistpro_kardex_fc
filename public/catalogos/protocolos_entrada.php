...
<div class="ap-container">
  ...
  <div class="ap-cards">
    ...
    <div class="ap-card" onclick="abrirImport();">
      ...
      <div class="k"><span class="ap-chip">UPSERT por ID_Protocolo</span></div>
    </div>
  </div>
  ...
  <div class="ap-toolbar">
    <div class="ap-search">
      ...
      <input id="q" placeholder="Buscar por ID_Protocolo, descripción o folio…" onkeydown="if(event.key==='Enter')buscar()">
...
<div class="ap-modal" id="mdl">
  <div class="ap-modal-content">
    <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap">
      <h3 style="margin:0"><i class="fa fa-clipboard-check"></i> Protocolo</h3>
      <div class="ap-chip"><span style="color:#dc3545;font-weight:700">*</span> Obligatorios: <b>ID_Protocolo</b>, <b>descripcion</b></div>
    </div>
    ...
    <div class="ap-form" style="margin-top:10px">
      <div class="ap-field">
        <div class="ap-label">ID_Protocolo *</div>
        <div class="ap-input"><i class="fa fa-hashtag"></i><input id="ID_Protocolo" placeholder="PRT-001"></div>
        <div class="ap-error" id="err_idp">ID_Protocolo obligatorio.</div>
      </div>

      <div class="ap-field">
        <div class="ap-label">Descripción *</div>
        <div class="ap-input"><i class="fa fa-align-left"></i><input id="descripcion" placeholder="Protocolo de entrada..."></div>
      ...
      <div class="ap-field">
        ...
        <div class="ap-input"><i class="fa fa-sort-numeric-up"></i><input id="FOLIO" placeholder="(opcional)" oninput="this.value=this.value.replace(/[^0-9]/g,'')"></div>
      </div>
    </div>
...
<div class="ap-modal" id="mdlImport">
  <div class="ap-modal-content">
    <h3><i class="fa fa-upload"></i> Importar Protocolos de Entrada</h3>
    <div class="ap-chip">Layout FULL con UPSERT por <b>ID_Protocolo</b>. Previsualiza antes de importar.</div>
  ...
  fetch(url).then(r=>r.json()).then(resp=>{
    ...
    rows.forEach(r=>{
      ...
      <tr>
        ...
        <td>${reqDot(r)}</td>
        <td>${r.id||''}</td>
        <td>${r.ID_Protocolo||''}</td>
        <td>${r.descripcion||''}</td>
        <td>${r.FOLIO===null || r.FOLIO===undefined ? '' : r.FOLIO}</td>
