...
<head>
  ...
  <style>
    ...
    .kpi-card{ font-size:10px; border-radius:10px; border:1px solid #e0e5f5; }
    .kpi-card .card-body{ padding:.5rem .75rem; }
    .kpi-title{ font-size:9px; text-transform:uppercase; letter-spacing:.05em; color:#6c7aa0; }
    .kpi-value{ font-size:16px; font-weight:700; }
    .kpi-sub{ font-size:9px; color:#6c7aa0; }
...
$(function(){
  ...
  const table = $('#tblLicensePlate').DataTable({
    ...
    columns: [
      ...
      { data: 'existencia_total', render: function(v){
